function [theta, log_weights, log_evidence, count_loglike, levels, R, cov_part, h] = stratified_RW(loglike_fn,logprior_fn,simprior_fn,options,verbose)
