...
for i=1:num_repeats
    ...
    rng(i);
    [log_evidence, count_loglike, gammavar] = ATA_SMC_bespoke_RW(@loglike_fn,@logprior_fn,@simprior_fn,options,false);
    ...
    rng(i+num_repeats);
    [log_evidence, count_loglike] = TA_SMC_bespoke_RW(@loglike_fn,@logprior_fn,@simprior_fn,options,false);
    ...
    rng(i);
    [log_evidence, count_loglike, levels] = ANS_SMC_bespoke_RW(@loglike_fn,@logprior_fn,@simprior_fn,options,false);
    ...
    rng(i+num_repeats);
    [log_evidence, count_loglike, error_flag] = NS_SMC_bespoke_RW(@loglike_fn,@logprior_fn,@simprior_fn,options,false);
    ...
    rng(i);
    [log_evidence, log_evidence_star, count_loglike] = NS_bespoke_RW(@loglike_fn,@logprior_fn,@simprior_fn,options,false);
...
clearvars -except N d alpha stopping_epsilon repeats log_evidence_* count_* error_flag_* num_repeats;
